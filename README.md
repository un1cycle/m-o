...
#### Description:
- This project is an immediate representation that optimally cleans up all heap-allocations without any safety rules or garbage collection. The project name and icon are from a Wall-E character named Microbe-Obliterator.
