# Memory-Obliterator
This project is an immediate representation that optimally cleans up all heap-allocations without any safety rules or garbage collection. The name is from a Wall-E character: Microbe-Obliterator.
